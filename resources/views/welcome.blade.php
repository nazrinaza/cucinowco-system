<x-layouts.public>
    ...
    <section class="experience-section section-pad"><div class="site-shell"><p class="eyebrow"><span></span> Thursina profile experience</p><h2>Work across complex,<br>high-expectation environments.</h2><p class="experience-lead">The supplied company profile records client and project experience associated with organisations and sites including:</p><div class="experience-list">@foreach([['Maybank.png','Maybank'],['CIMB.png','CIMB'],['Tenaga Nasional.png','Tenaga Nasional'],['University of Malaya.png','University of Malaya'],['UiTM.png','UiTM'],['JKR.png','JKR'],['MRT.png','MRT Corp'],['Perodua.png','Perodua'],['Proton.png','Proton'],['J&T Express.png','J&T Express'],['Firefly.png','Firefly'],['NSG Group.png','NSG Group']] as [$file,$client])<figure class="experience-logo"><img src="{{ asset('images/clients/'.$file) }}" alt="{{ $client }} logo" loading="lazy" decoding="async"></figure>@endforeach</div><p class="source-note">Logos reflect historical company-profile experience and do not imply current contracts or endorsements.</p></div></section>
