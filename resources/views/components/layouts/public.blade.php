...
<body class="bg-cream text-ink antialiased">
    ...
    <header class="site-header" data-header>
        <div class="site-shell header-inner">
            ...
            <nav id="primary-navigation" class="primary-nav" aria-label="Primary navigation" data-menu>
                <a href="#scope-guide">Space &amp; clean guide</a>
    ...
    <footer class="site-footer">
        <div class="site-shell footer-grid">
            ...
            <div><h2>Business</h2><p>{{ config('company.legal_name') }}</p><p>Reg. {{ config('company.registration_number') }}</p><a href="{{ route('login') }}">Admin access</a></div>
        </div>
